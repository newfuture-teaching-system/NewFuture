...
<body style="height: 100%;">
	<nav class="navbar-default" role="navigation">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="teacherCenter.jsp"><span class="glyphicon glyphicon-user"></span>
	...
	<div class="col-md-2" id="functionList">
		<ul class="nav nav-pills nav-stacked">
			<li class="active"><a href="#">教师中心</a></li>
			<li><a href="selectCourseInfo.do?teacherId=${sessionScope.user.getUserId()}&page=1" target="rightframe">教师授课</a></li>
			<li><a href="updateUserInfo.jsp" target="rightframe">修改登陆信息</a></li>
			<li><a href="TeacherInformation.do?teacherId=${sessionScope.user.getUserId()}" target="rightframe">修改个人信息</a></li>
		</ul>
	</div>
