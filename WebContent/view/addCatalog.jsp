...
<body style="text-align: center">
	<form action="addOne.do" id="oneForm">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">录入一级目录</h3>
	</div>
	<div class="panel-body"  style="text-align:center">
		 
    
        <table class="table table-bordered table-condensed" style="width: 500px;margin: auto;">
			<thead>
				<tr class="info">
					<th>目录序号</th>
					<th>目录名称</th>
			...
			<tbody id="tb">
			<tr>
					<td><input type="text" name="num" class="num" required="required"></td>
					<td><input type="text" name="catalogOneName"  required="required"></td>
					<td><input type="text" name="content"  required="required"></td>
					<td> &nbsp;&nbsp;<a onclick="addOne()"><span class="glyphicon glyphicon-plus-sign"></span></a>&nbsp;&nbsp;</td>
			</tr>
			</tbody>
		</table>
